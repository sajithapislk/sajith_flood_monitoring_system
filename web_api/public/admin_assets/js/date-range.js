...
$(function() {
  ...
  if ($("#daterangepicker")) {
    ...
    var cb = function(start, end) {
      $(".date-range-report span").html(
        start.format("YYYY/MM/DD") + " - " + end.format("YYYY/MM/DD")
      );
    };

    $(".date-range-report").daterangepicker(
      {
        startDate: start,
        endDate: end,
        opens: 'left',
  ...
  //   var start = moment();
  //   var end = moment().subtract(24, "month");

  //   var cb = function(start, end) {
  //     $("#production-history .date-range-report span").html(
  //       start.format("YYYY/MM/DD") + " - " + end.format("YYYY/MM/DD")
  //     );
  //   };

  //   $("#production-history .date-range-report").daterangepicker(
  //     {
  //       startDate: start,
  //       endDate: end,
  //       opens: 'left',
